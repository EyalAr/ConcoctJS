...
// . templates (string / array) - templates directory path / list of paths.
// . contexts (string / array) - JSON contexts directory path / list of paths.
// . plugins
// . linkingRules
    ...
    function concoct(next) {
        ...
        _plugins.forEach(function(plugin) {
            ...
            workflow.push(function(next) {
                ...
                plugin.handler(plugin.params, _templates, _contexts, _links, next);
